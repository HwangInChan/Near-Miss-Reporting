 ...
 */
const FACTOR_MEASURES: Record<ContributingFactor, ControlMeasure[]> = {
  "조도 부족": [
  ...
  소음: [
    ...
    { level: "공학적", action: "방음 커버·차음벽 설치, 소음 측정 및 지도 작성" },
    { level: "보호구", action: "청력보호구 지급 및 착용 관리 (차음 성능 확인)" },
  ],
  "작업 절차 미숙지": [
    { level: "관리적", action: "작업표준(SOP) 재정비 및 현장 게시" },
    { level: "관리적", action: "신규·전환 배치자 OJT 강화, 이해도 확인 절차 추가" },
  ],
  "보호구 미착용": [
    { level: "공학적", action: "보호구가 필요 없도록 위험원 방호 조치 우선 검토" },
    { level: "관리적", action: "착용 점검 체크리스트 운영 및 관리감독자 확인" },
    { level: "보호구", action: "작업 지점 인근에 보호구 비치해 접근성 개선" },
  ],
  "정리정돈 불량": [
    { level: "공학적", action: "통로 구획선 재도색, 자재 지정 적치구역 설정" },
    { level: "관리적", action: "5S 활동 정례화 및 작업 종료 시 정리 점검" },
  ],
  "작업 압박(시간)": [
